"""Canonical data-lake prefix templates for ProjectEdge."""
...
# Prefix-only directories used for MinIO bootstrap markers.
CANONICAL_PREFIX_DIRECTORIES: Final[tuple[str, ...]] = (
    "raw/",
    "processed/tracking/",
    "processed/plays/",
    "processed/scores/",
